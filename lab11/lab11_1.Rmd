...
years should be factors! if they are numberics that means you would normally add them/find the mean
...
color is the outline color of the bar
```{r}
homerange %>% 
...
```{r}
library(gtools)
quaritles <- quantcut(homereange$log10.hra)
table(quartiles)
```
