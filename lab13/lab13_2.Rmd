...
```{r}
if (!require("tidyverse")) install.packages('tidyverse') # important for people who don't commonly use R. 
```
...
server <- function(input, output, session) {
  session$onSessionEnded(stopApp) #stop app as soon as its closed
