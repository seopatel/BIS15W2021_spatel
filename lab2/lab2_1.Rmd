...
my_experiment
```
# Tab complete - prevents spelling errors
press command + return on Mac to run 
```{r}
my_experiment
...
This means that the mean cannot be computed if there is missing data and shows that NAs are very important
